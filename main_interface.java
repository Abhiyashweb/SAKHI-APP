...
public class main_interface { //primary color = ec2525
    JFrame f;
    JTextField search,t_date, t_code;
    JLabel logo,dsa,s,l_date,l_code, subject_name, lfilepath, imglabel, imglable0;
...
//         logo.setBounds(20,45,120,120);
         ...
         bresult.setBackground(new Color(0xec2525));//new Color(0xF08080)
         binstantNotice.setBackground(new Color(0xec2525));
         bassignment.setBackground(new Color(0xec2525));
         batendance.setBackground(Color.white);
         btest.setBackground(new Color(0xec2525));
